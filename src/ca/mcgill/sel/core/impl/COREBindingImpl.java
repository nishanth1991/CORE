 ...
 * <ul>
 *   <li>{@link ca.mcgill.sel.core.impl.COREBindingImpl#getCoreMappings <em>Core Mappings</em>}</li>
 * </ul>
 * </p>
 *
 * @generated
...
public abstract class COREBindingImpl extends CORECompositionSpecificationImpl implements COREBinding {
     ...
     * @ordered
     */
    protected EList<COREMapping> coreMappings;
     ...
     * @generated
     */
    public EList<COREMapping> getCoreMappings() {
        if (coreMappings == null) {
            coreMappings = new EObjectResolvingEList<COREMapping>(COREMapping.class, this, CorePackage.CORE_BINDING__CORE_MAPPINGS);
        }
        return coreMappings;
    }
    ...
    public void eSet(int featureID, Object newValue) {
        switch (featureID) {
            case CorePackage.CORE_BINDING__CORE_MAPPINGS:
                ...
                getCoreMappings().addAll((Collection<? extends COREMapping>)newValue);
                return;
        }
